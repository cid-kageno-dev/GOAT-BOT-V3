...
// --- RENDER PORT FIX By Cid Kageno ---
const http = require('http');
const renderPort = process.env.PORT || 3000;
const keepAliveServer = http.createServer((req, res) => {
    res.writeHead(200, { 'Content-Type': 'text/plain' });
    res.end('GoatBot V3 is running on Render!');
});
keepAliveServer.listen(renderPort, '0.0.0.0', () => {
    console.log(`Render Keep-Alive Server listening on port ${renderPort}`);
});
